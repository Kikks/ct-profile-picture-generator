  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3 rounded-xl bg-green-50 p-4 dark:bg-green-950">
        <CheckCircle2Icon className="h-8 w-8 flex-shrink-0 text-green-600 dark:text-green-400" />
        <div>
      ...
      {isPublished && (
        <div className="space-y-3">
          ...
          <div className="flex items-stretch gap-2">
            <div className="flex flex-1 items-center rounded-lg border border-border bg-muted px-3 py-2 text-sm">
      ...
      <div className="flex gap-3">
        <Button variant="outline" render={<Link href="/admin" />} className="flex-1">
          View All Templates
        </Button>
        <Button
          render={
            isPublished ? (
              ...
              <button onClick={() => toast.info("Publish the template first to see it.")} />
            )
          }
          className="flex-1"
        >
